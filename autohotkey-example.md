...
#^t::Run "C:\Users\zte\AppData\Local\Microsoft\WindowsApps\wt.exe" --window 0 new-tab
#^c::Run "C:\app\ConEmu\ConEmu64.exe" -reuse -run "{cmd}" -new_console
#^g::Run "C:\app\ConEmu\ConEmu64.exe" -reuse -run "{Git Bash}" -new_console
#^w::Run "C:\app\ConEmu\ConEmu64.exe" -reuse -run "{WSL Bash}" -new_console:P:"gruvbox-dark"
...
#^+c::Run "C:\Program Files (x86)\Chocolatey GUI\ChocolateyGui.exe"

SC1F65::
MsgBox
return

::emilka::MyFirtName.MySurName@thisismycompanyslongdomainname.com
